		...
		public void map(Object key, Text value, Context context)
			...
			for (Rectangle rec : recList) {
				if(rec.containPoints(point)) {
					context.write(new IntWritable(rec.getRecId()), new Text(point.toStringIntWithBracket()));
				}
			}
		}
	}
...
//				.getRemainingArgs();
		...
		job.setJarByClass(Problem1aBK.class); // change the class here
