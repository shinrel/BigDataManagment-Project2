...
import utils.Utils;
public class Problem3Kmean1 {
	// private static final Log LOG =
	// LogFactory.getLog(Problem2.class.getName());
	private static final Logger logger = Logger.getLogger(Problem3Kmean1.class
			.getName());
	...
	public static class MyMapperProblem3Kmean extends
		...
		public void map(Object key, Text value, Context context)
			...
			context.write(new IntWritable(closestCenterIdx), new Text(p.toString()));
		}
	}
	...
	public static void run(String[] args) throws Exception {
		...
		Job job = new Job(conf, "Project 3, Problem 1");
		// conf.set("kSeedPath", otherArgs[0]);

		
		job.setJarByClass(Problem3Kmean1.class); // change the class here
